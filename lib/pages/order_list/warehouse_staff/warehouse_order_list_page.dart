...
class WarehouseOrderListPage extends StatefulWidget {
  const WarehouseOrderListPage({super.key});

  @override
  State<WarehouseOrderListPage> createState() => _WarehouseOrderListPageState();
}

class _WarehouseOrderListPageState extends State<WarehouseOrderListPage> {
  int selectedTab = 0;
  String query = '';
                      ...
                      return SliverPadding(
                        ...
                        sliver: SliverList.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final lastItem = index == orders.length - 1;
                            final isProcessing = state.processingOrderIds
                                .contains(order.id!);
                            final canConfirmPickup =
                                order.orderStatus == OrderStatus.NEED_PICKUP &&
                                !isProcessing;
                            ...
                            return WarehouseOrderCard(
                              ...
                              onConfirmPickup: canConfirmPickup
                                  ? () {
                                      context.read<OrderBloc>().add(
                                        MarkOrderAsPickedUp(orderId: order.id!),
                                      );
                                    }
                                  : null,
                              firstItem: index == 0,
