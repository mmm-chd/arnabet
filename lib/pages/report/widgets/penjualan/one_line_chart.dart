...
class OneLineChart extends StatelessWidget {
  ...
  const OneLineChart({super.key, this.chart});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(
                  text: "Berdasarkan omzet periode ini",
                  style: TextStyle(
                    fontSize: 12,
...
class _ChartContent extends StatelessWidget {
  ...
  List<num> get _values => [...?chart?.omset];
  ...
  @override
  Widget build(BuildContext context) {
    final omzetSpots = List.generate(
      chart?.omset?.length ?? 0,
      (i) => FlSpot(i.toDouble(), chart!.omset![i].toDouble()),
    );

    final double maxValue = _values.isEmpty
        ? 10.0
        : _values.reduce((a, b) => a > b ? a : b).toDouble();
    final double minValue = _values.isEmpty
        ? 0
        : _values.reduce((a, b) => a < b ? a : b).toDouble();
